...
namespace BfmeFoundationProject.WorkshopKit.Data
{
    public struct BfmeWorkshopEntry
    {
        ...
        public BfmeWorkshopEntryPreview Preview(BfmeWorkshopEntryMetadata metadata) => new BfmeWorkshopEntryPreview() { Guid = Guid, Name = Name, Version = Version, Description = Description, ArtworkUrl = ArtworkUrl, Author = Author, Owner = Owner, Game = Game, Type = Type, CreationTime = CreationTime, Metadata = metadata };
